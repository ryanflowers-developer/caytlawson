    ...
    <v-container>
        <v-row>
            <v-col class="text-center" cols="12">
                <h1 class="mx-auto">Official Bio</h1>
            </v-col>
            <v-col class="text-justify">
                <p><span id="big-l">C</span>ayt Lawson obtained a degree in Liberal Studies and aspires to further her college education in the future, purely for the enjoyment of learning. She quite possibly would have made a career as a student; alas, the financial carnage that would’ve wrecked, made that a less than viable option.
                ...
                Thank you for visiting her site! You can also connect with Cayt Lawson by email via <a href="mailto:caytlawson@gmail.com">caytlawson@gmail.com</a>. 
                </p>
